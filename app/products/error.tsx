  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">שגיאה בטעינת המוצרים</h2>
        <p className="text-gray-600 mb-8">אירעה שגיאה בטעינת עמוד המוצרים. אנא נסו שוב מאוחר יותר.</p>
