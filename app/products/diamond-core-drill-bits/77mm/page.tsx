...
const product = {
  id: 'arix-77mm',
  name: 'כוס קידוח יהלום לקידוח רטוב עם סגמנט Arix – בקוטר 77 מ"מ',
  description: 'כוס קידוח מקצועית עם סגמנט Arix בקוטר 77 מ"מ, מתאימה לקידוח רטוב בבטון, בטון מזוין וחומרים קשים. איכות מעולה וביצועים מיטביים עם אורך חיים ארוך במיוחד.',
  diameter: '77 מ"מ',
  length: '450 מ"מ',
  thread: '1-1/4" UNC',
  segments: 8,
